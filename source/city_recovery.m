...
% Recovers the emission for some inventory using footprints. For recovery
% sparse reconstruction in the spatial and wavelet domain, as well as the
% regularized least square are used. As output, a text file with some
% information and multiple plots, such as a smoothing plot, is provided.
...
%% Least Square
emission_l2_vec = pinv(sensing_matrix) * obs_vec;
